...
Spatially resolved transcriptomics (ST) technologies allow transcriptome-wide gene expression to be measured at spatial resolution. There are several technological platforms, each with their unique advantages. In 2020 Spatially resolved transcriptomics was named the method of the year @Mark2020 and we expect that it will help put the genome-wide expression on the map @Maynard2020Spatial.
