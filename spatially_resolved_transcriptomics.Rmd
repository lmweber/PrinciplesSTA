...
```{r Visium-schematic, fig.wide=TRUE, echo=FALSE, fig.cap="Schematic of 10x Genomics Visium platform. Image source: 10x Genomics Visium website: https://www.10xgenomics.com/spatial-transcriptomics/"}
