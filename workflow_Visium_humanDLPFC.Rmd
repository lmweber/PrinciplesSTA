...
```{r QC_thresholds, fig.width=7, fig.height=3}
...
spe_nnSVG <- filter_genes(
  spe_nnSVG, filter_genes_ncounts = 5, filter_genes_pcspots = 1
)
...
# run nnSVG
# using a single core for build system
set.seed(123)
...
rowData(spe_nnSVG)[order(rowData(spe_nnSVG)$rank)[1:10], ]
...
```{r clustering_plots_reduced, fig.width=5, fig.height=4.25}
