...
```{r plot_lib_size_scatter, message=FALSE, fig.height=3.75}
library(spatzli)
...
```{r plot_detected_scatter, fig.height=3.75}
...
```{r plot_mito_scatter, fig.height=3.75}
...
```{r plot_cell_count_scatter, fig.height=3.75}
# plot number of expressed genes vs. number of cells per spot
plotQCscatter(spe, 
              metric_x = "cell_count", metric_y = "detected", 
