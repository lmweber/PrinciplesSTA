...
```{r plot_lib_size_hist, fig.height=3.75}
...
```{r plot_lib_size_spatial, fig.height=3.75}
...
```{r plot_lib_size_spatial_too_high, fig.height=3.75}
...
```{r plot_ground_truth, message=FALSE, fig.height=3.75}
library(ggspavis)
...
```{r plot_detected_hist, fig.height=3.75}
...
```{r plot_detected_spatial, fig.height=3.75}
# check spatial pattern of discarded spots
...
```{r plot_detected_spatial_too_high, fig.height=3.75}
# check spatial pattern of discarded spots if threshold is too high
...
```{r plot_mito_hist, fig.height=3.75}
...
```{r plot_mito_spatial, fig.height=3.75}
# check spatial pattern of discarded spots
...
```{r plot_mito_spatial_too_low, fig.height=3.75}
# check spatial pattern of discarded spots if threshold is too high
...
```{r plot_cell_count_hist, fig.height=3.75}
...
```{r plot_cell_count_spatial, fig.height=3.75}
# check spatial pattern of discarded spots
...
```{r plot_discarded_spatial, fig.height=3.75}
