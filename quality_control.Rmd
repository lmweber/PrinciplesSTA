...
```{r plot_data, message=FALSE, fig.height=3.5}
library(ggspavis)
...
```{r plot_lib_size_hist, fig.height=3.5}
...
```{r plot_lib_size_scatter, message=FALSE, fig.width=3.75, fig.height=3.75}
library(spatzli)
...
```{r plot_lib_size_spatial, fig.height=3.5}
...
```{r plot_lib_size_spatial_too_high, fig.height=3.5}
...
```{r plot_ground_truth, message=FALSE, fig.height=3.5}
library(ggspavis)
...
```{r plot_detected_hist, fig.height=3.5}
# histogram of numbers of expressed genes
hist(colData(spe)$detected, breaks = 25)
```

```{r plot_detected_scatter, fig.width=3.75, fig.height=3.75}
...
```{r plot_detected_spatial, fig.height=3.5}
# check spatial pattern of discarded spots
...
```{r plot_detected_spatial_too_high, fig.height=3.5}
# check spatial pattern of discarded spots if threshold is too high
...
```{r plot_mito_spatial, fig.height=3.5}
# check spatial pattern of discarded spots
...
```{r plot_mito_spatial_too_low, fig.height=3.5}
# check spatial pattern of discarded spots if threshold is too high
...
```{r plot_cell_count_hist, fig.height=3.5}
...
```{r plot_cell_count_scatter, fig.width=3.75, fig.height=3.75}
# plot number of expressed genes vs. number of cells per spot
plotQCscatter(spe, 
              metric_x = "cell_count", metric_y = "detected", 
...
```{r plot_cell_count_spatial, fig.height=3.5}
# check spatial pattern of discarded spots
...
```{r plot_discarded_spatial, fig.height=3.5}
