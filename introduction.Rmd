...
- **Introduction:** introductory material, description of spatial transcriptomics technologies and data structure, description of datasets used in the examples, and processing steps for raw data

- **Analysis pipeline:** sequence of chapters describing the main steps in a computational analysis pipeline for ST data using the Bioconductor framework, including examples of R code that can be run on your own laptop
