...
In particular, we welcome new [Workflows]. These are chapters in OSTA that describe a complete workflow, consisting of several individual analysis steps. For example, these may be focused on a specific type of technological platform, or designed to showcase a certain type of analysis. To make the examples easier for readers to follow, we recommend re-using code from the individual analysis chapters within workflows, e.g. for standard analysis steps.
