...
The subset of data used in this workflow (sample 151673) is also available from the [STexampleData](https://github.com/lmweber/STexampleData) package.
...
```{r load_data_humanDLPFC, message=FALSE}
