...
Load the dataset from the [STdata](https://github.com/lmweber/STdata) package. The data object is formatted in the `SpatialExperiment` object class defined in the [SpatialExperiment](https://bioconductor.org/packages/SpatialExperiment) package.

Note that this is a subset containing only one sample (sample 151673) from the full dataset.
...
Visualization functions for QC purposes are available in the [spatzli](https://github.com/lmweber/spatzli) package. Additional visualization functions are available in the [ggspavis](https://github.com/lmweber/ggspavis) package.
...
For the visualizations, we use functions from the [ggspavis](https://github.com/lmweber/ggpavis) package.
