...
## TO DO: convert STdata to an ExperimentHub package; currently is a temporary
## wrapper around Dropbox links

## TO DO: convert to use SpatialExperiment instead of SingleCellExperiment class
