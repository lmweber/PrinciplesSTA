...
```{r spe-schematic, echo=FALSE, out.width = "80%", fig.align="center", fig.cap="Overview of the `SpatialExperiment` object class for storing spatially resolved transcriptomics datasets in the Bioconductor framework."}
