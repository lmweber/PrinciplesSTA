...
Spatially resolved transcriptomics (SRT) technologies allow transcriptome-wide gene expression to be measured at spatial resolution. There are several technological platforms, each with their unique advantages. SRT was named the Method of the Year by Nature Methods in 2020 [@Mark2020] and we expect that it will help put genome-wide expression on the map [@Maynard2020Spatial].
...
This platform is commercially available from 10x Genomics.
...
- [MERSCOPE](https://vizgen.com/products/) (commercially available)
