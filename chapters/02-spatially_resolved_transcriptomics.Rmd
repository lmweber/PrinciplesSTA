...
Spatially-resolved transcriptomics (SRT) represents a new class of high-throughput genomic technologies that enable the measurement of up to thousands of genes at up to thousands of measurement locations, usually on two-dimensional tissue sections. A number of platforms have been developed, each with their unique advantages. SRT was named the Method of the Year by Nature Methods in 2020 [@Mark2020] and has found widespread application in numerous biological systems.

For recent reviews of available platforms, computational analysis methods, and outstanding challenges, see [Bressan et al. 2023](https://www.science.org/doi/10.1126/science.abq4964) and [Moses et al. 2022](https://www.nature.com/articles/s41592-022-01409-2).
